...
export const MODELS = [
  {
    ...
    parts: {
      "blip 1 (lightning arrestor)": {
        ...
        purpose:
          "Lightning protection: Safely directs lightning energy into tower grounding system. Radio communication: Used for low-power links such as monitoring, control, or backup communication",
        material:
  ...
  },
  {
    ...
    parts: {
      "blip 1 (massive mimo antennas)": {
        ...
        material:
          "Radome: RF-transparent composite plastic or fiberglass. Internal antenna elements: Copper or aluminum. Mounting brackets: Galvanized steel or aluminum. Cabling: Shielded copper RF cables and fiber optic cables",
      },
  ...
  },
  {
    ...
    parts: {
      "blip 1 (sector panel antennas)": {
        ...
        positionReason: "Maximizes coverage radius in open terrain",
        purpose: "Primary cellular communication (2G–5G)",
        material: "RF-transparent radome, aluminum/copper radiating elements",
      },
      ...
      "Blip 2 (Microwave Dish Antenna)": {
        ...
        positionReason: "Clear line-of-sight with reduced wind loading",
        purpose: "Point-to-point backhaul data transmission",
        material: "Aluminum dish, galvanized steel mounting",
      },
      Mesh023_5: {
        label: "Microwave Backhaul Dish Antenna",
        icon: "📶",
      ...
      "blip 3 (tower base platform)": {
        ...
        positionReason: "Provides safe access for maintenance personnel",
        purpose: "Structural access and safety platform",
        material: "Galvanized steel platform, reinforced concrete base",
      },
